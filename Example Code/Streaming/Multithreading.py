...
FIXED_TRANSFER_SIZE = True # Fix the transfer size. DO NOT enable unless STREAM_SIZE is a multiple of MaxPacketSize.
...
# Max performance = 100 MiB/s for the FT600. 200 MiB/s for the FT601.
